    ...
    <div class="w-full max-w-md">
      <form class="mt-8 bg-white rounded-lg shadow-xl overflow-hidden" @submit.prevent="submit">
        <div class="px-10 py-12">
          <h1 class="text-center font-bold text-3xl">Painel do administrador</h1>
          ...
          <text-input v-model="form.password" class="mt-6" label="Senha" placeholder="Senha" type="password" />
        ...
        <div class="px-10 py-4 bg-gray-100 border-t border-gray-200 flex justify-between items-center">
          ...
          <loading-button :loading="sending" class="btn-indigo" type="submit">Iniciar sessão</loading-button>
        </div>
      </form>
    </div>
  </div>
